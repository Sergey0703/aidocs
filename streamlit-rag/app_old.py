#!/usr/bin/env python3
"""
Updated Streamlit RAG Chat Application
With improved models: mxbai-embed-large + mistral-nemo:12b
"""
...
CONFIG = {
    ...
    "embed_model": "mxbai-embed-large",     # ????: nomic-embed-text
    "chat_model": "llama3:8b-instruct-q4_K_M",       # ????: llama3 llama3:8b-instruct-q4_K_M  mistral-nemo-small
    "embed_dim": 1024,                      # ????: 768
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        **Vector Dimension:** {CONFIG['embed_dim']}
...
def main():
    ...
    st.markdown("**Enhanced with:** `mxbai-embed-large` + `mistral-nemo:12b`")
    st.markdown("---")
